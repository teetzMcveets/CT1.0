...
export const jamieFranks = {
    ...
    access: [],
    contactPref: [],
    address1: 'Unit 1 Caroline Point',
    address2: '1 Caroline Street',
    address3: 'The Jewellery Quarter',
    cityTown: 'Birmingham',
    county: '',
    postCode: 'B3 1UF',
    movedIn: '2010-01-01',
    ...
    permitExpiry: '',
    criminalConvictions: 'Yes',
    criminalConvictionsDetails: 'Drunk and disorderly',
    //Preference Questions
    startDate: '2023-05-30',
    commuteType: '',
    travelForWork: '',
